            ...
            <ul class="navbar-nav d-flex flex-row me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="employeesDropdown">
                        <li><a class="dropdown-item" href="{{ route('stud_placements.index') }}">Stdplacements</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="employeesDropdown">
                        <li><a class="dropdown-item" href="{{ route('blocks.index') }}">Employees</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="employeesDropdown" role="button"
                    ...
                    <ul class="dropdown-menu" aria-labelledby="employeesDropdown">
                        <li><a class="dropdown-item" href="{{ route('rooms.index') }}">Employees</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="proctorPlacementDropdown">
                        <li><a class="dropdown-item" href="{{ route('blocks.index') }}">Blocks</a>
                        </li>
                    </ul>
                </li>
...
<nav class="navbar navbar-light bg-light" style="background-color:pink">
